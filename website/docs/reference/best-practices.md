...
description: "These two lived here and in `CLAUDE.md`, which is carried into every session; the same fact in two places is how the anti-pattern lists in this reposi"
tags:
  - "reference"
---
